...
:global(.rev-card) {{ margin: 0; background: #F4F6FB; border: 1px solid var(--rule, #E2E6F0); border-radius: 14px; padding: 20px 22px; display: flex; flex-direction: column; gap: 12px; }}
:global(.rev-stars) {{ color: #F0B400; font-size: 15px; letter-spacing: 2px; }}
:global(.rev-text) {{ margin: 0; font-size: 14.5px; line-height: 1.6; color: var(--ink, #171733); }}
:global(.rev-meta) {{ display: flex; flex-direction: column; gap: 2px; margin-top: auto; }}
:global(.rev-who) {{ font-family: var(--font-heading, inherit); font-weight: 700; font-size: 13px; color: var(--freedom-blue, #1E1E77); }}
:global(.rev-when) {{ font-size: 12px; color: var(--muted, #5B6079); }}
